  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black via-zinc-900 to-black px-6">
      ...
      >
        ...
        {/* Google Login */}
        <button
          className="w-full flex items-center justify-center gap-3 border border-zinc-700 hover:border-mainCol/70 py-3 rounded-xl mb-6 transition"
        >
          <FcGoogle size={22} />
        ...
        <form className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 text-zinc-400">
              <input type="checkbox" className="accent-mainCol" />
              Remember me
            </label>
          ...
          <button
            type="submit"
            className="w-full bg-mainCol hover:opacity-90 py-3 rounded-xl font-semibold transition text-gary-200"
          >
            Login
          </button>
        </form>
